...
echo "*****************************ATTENTION**********************************"
echo "*                                                                      *"
echo "* Since this version changes the app name from cylonix to cylonix-app, *"
echo "* if you are not installing for the 1st time, please log out and log   *"
echo "* back in of your desktop for all changes to take effect.              *"
echo "*                                                                      *"
echo "************************************************************************"
echo ""