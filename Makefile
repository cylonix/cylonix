...
windows_cylonixd:
	cd ./tailscale && TAGS=ts_tcp_safesocket GOOS=windows GOARCH=amd64 ./build_dist.sh tailscale.com/cmd/tailscaled
	cd ./tailscale && TAGS=ts_tcp_safesocket GOOS=windows GOARCH=amd64 ./build_dist.sh tailscale.com/cmd/tailscale
