 ...
 *
 * Or if you want to cache the result make sure you invalidate the cache on any
 * network change.
 *
 * It is always better to use a new instance of the detector when you need
 * current DNS servers otherwise you may get into troubles because of
 * invalid/changed DNS servers.
 *
 * This class combines various methods and solutions from: Dnsjava
 * http://www.xbill.org/dnsjava/ Minidns https://github.com/MiniDNS/minidns
 *
 * Unfortunately both libraries are not aware of Orero changes so new method was
 * added to fix this.
 *
...
public class DnsServersDetector {
    ...
    /**
     * Holds some default DNS servers used in case all DNS servers detection methods
     * fail. Can be set to null if you want caller to fail in this situation.
     */
    ...
    public String[] getServers() {
        ...
        // LAST METHOD: detect android DNS servers by executing getprop string command
        // in a separate process
        // This method fortunately works in Oreo too but many people may want to avoid
        // exec
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {
                ...
                if (connectivityManager != null) {
                    ...
                    // Notice that android LOLLIPOP or higher allow iterating multiple connected
                    // networks of SAME type
                    for (Network network : connectivityManager.getAllNetworks()) {
                        ...
                        if (networkInfo.isConnected()) {
                            ...
                            String linkName = linkProperties.getInterfaceName();
                            ...
                            if (linkPropertiesHasDefaultRoute(linkProperties)) {
                                ...
                                for (InetAddress element : dnsServersList) {
                                    ...
                                    String dnsHost = linkName + "/" + element.getHostAddress();
     ...
     *
     * This method is NOT working anymore in Android 8.0 Official Android
     * documentation state this in the article Android 8.0 Behavior Changes. The
     * system properties net.dns1, net.dns2, net.dns3, and net.dns4 are no longer
    ...
    /**
     * Detect android DNS servers by executing getprop string command in a separate
     * process
     *
     * Notice there is an android bug when Runtime.exec() hangs without providing a
     * Process object. This problem is fixed in Jelly Bean (Android 4.1) but not in
     * ICS (4.0.4) and probably it will never be fixed in ICS.
    ...
    private Set<String> methodExecParseProps(BufferedReader lineNumberReader) throws Exception {
        ...
        while ((line = lineNumberReader.readLine()) != null) {
            ...
            if (valueEnd < valueStart) {
                ...
                // This can happen if a newline sneaks in as the first character of the property
                // value. For example
                // "[propName]: [\n…]".
     ...
     * @return true if the specified link properties have default route or false
     *         otherwise
     */
